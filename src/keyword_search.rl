...
'\\affiliation{' => { printf("%s:%zd:%zd\n", "\\affiliation{",ts-in,te-in);};
'\\author{' => { printf("%s:%zd:%zd\n", "\\author{",ts-in,te-in);};
'\\bibitem{' => { printf("%s:%zd:%zd\n", "\\bibitem{",ts-in,te-in);};
'\\caption{' => { printf("%s:%zd:%zd\n", "\\caption{",ts-in,te-in);};
'\\cite{' => { printf("%s:%zd:%zd\n", "\\cite{",ts-in,te-in);};
'\\end{' => { printf("%s:%zd:%zd\n", "\\end{",ts-in,te-in);};
'\\frac{' => { printf("%s:%zd:%zd\n", "\\frac{",ts-in,te-in);};
'\\includegraphics{' => { printf("%s:%zd:%zd\n", "\\includegraphics{",ts-in,te-in);};
'\\label{' => { printf("%s:%zd:%zd\n", "\\label{",ts-in,te-in);};
'\\mathbf{' => { printf("%s:%zd:%zd\n", "\\mathbf{",ts-in,te-in);};
'\\omicron{' => { printf("%s:%zd:%zd\n", "\\omicron{",ts-in,te-in);};
'\\ref{' => { printf("%s:%zd:%zd\n", "\\ref{",ts-in,te-in);};
'\\scalebox{' => { printf("%s:%zd:%zd\n", "\\scalebox{",ts-in,te-in);};
'\\section{' => { printf("%s:%zd:%zd\n", "\\section{",ts-in,te-in);};
'\\sqrt{' => { printf("%s:%zd:%zd\n", "\\sqrt{",ts-in,te-in);};
'\\title{' => { printf("%s:%zd:%zd\n", "\\title{",ts-in,te-in);};
'\\usepackage{' => { printf("%s:%zd:%zd\n", "\\usepackage{",ts-in,te-in);};
